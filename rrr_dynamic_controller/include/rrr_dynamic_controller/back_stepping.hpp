...
{
    class Back_Stepping : public controller_interface::Controller<hardware_interface::EffortJointInterface>
    {
        public:
            Back_Stepping();
            ~Back_Stepping();
        ...
        //M,C,G 
        Eigen::Matrix3d  J_,J_dot_,old_J_,J_T_,J_inv_,J_inv_T_,prova,Kv_,Kp_;
        ...
        int new_cmd;
        KDL::JntArray cylinder_cmd, cmd_effort , cmd_EE_state, init_cyl, advance_s, act_EE_vel_,old_qr_dot,qr_dot_,qr_dot_dot_;
