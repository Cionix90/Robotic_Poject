...
namespace gazebo_clik
{
    class Gazebo_Clik : public controller_interface::Controller<hardware_interface::EffortJointInterface>
    {
...
PLUGINLIB_EXPORT_CLASS(gazebo_clik::Gazebo_Clik, controller_interface::ControllerBase);
}